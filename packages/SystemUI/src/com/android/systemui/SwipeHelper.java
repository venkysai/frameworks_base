...
public class SwipeHelper implements Gefingerpoken {
    ...
    private static final float SWIPE_ESCAPE_VELOCITY = 200f; // dp/sec
    private static final int DEFAULT_ESCAPE_ANIMATION_DURATION = 100; // ms
    private static final int MAX_ESCAPE_ANIMATION_DURATION = 200; // ms
    private static final int MAX_DISMISS_VELOCITY = 4000; // dp/sec
    private static final int SNAP_ANIM_LEN = SLOW_ANIMATIONS ? 600 : 100; // ms
